...
class Member extends CI_Controller
{
        ...
        if ($user) {
            ...
            if ($user['is_active'] == 1) {
                ...
                if (password_verify($password, $user['password'])) {
                    ...
                    $this->session->set_flashdata('pesan', '<div class="alert alert-danger alert-
    ...
    public function daftar()
    {
        ...
        success alert-message" role="alert">Selamat!! akun anggota anda sudah dibuat.</div>');
        redirect(base_url());
    }
    ...
    public function ubahProfil()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($upload_image) {
                ...
                if ($this->uoload->do_upload('image')) {
